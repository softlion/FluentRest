...
namespace FluentRest.SourceGenerator
{
	public class HttpExtensionMethod : ExtensionMethod
	{
		...
		public override string Description => string.Concat(
			(ExtendedTypeArg.Type == "IFluentRestRequest") ? "Sends" : "Creates a FluentRestRequest and sends",
			" an asynchronous ",
		...
		public string TaskArg {
			get {
				switch (ResponseBodyType) {
					...
					default: return "IFluentRestResponse";
				}
			}
		}
		...
		public string ReturnTypeDescription {
			get {
				...
				switch (ResponseBodyType) {
					...
					default: return "the received IFluentRestResponse";
				}
			}
		}
	}
