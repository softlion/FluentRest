...
namespace FluentRest.Http.Testing
{
	...
	/// </summary>
	internal static class FluentRestDetailExtensions
	{
		internal static bool HasAnyVerb(this FluentRestDetail call, HttpMethod[] verbs) {
			// for good measure, check both FluentRestRequest.Verb and HttpRequestMessage.Method
			return verbs.Any(verb => call.Request.Verb == verb && call.HttpRequestMessage.Method == verb);
		}

		internal static bool HasAnyVerb(this FluentRestDetail call, string[] verbs) {
			// for good measure, check both FluentRestRequest.Verb and HttpRequestMessage.Method
		...
		/// </summary>
		internal static bool HasQueryParam(this FluentRestDetail call, string name, object value = null) {
			if (value == null)
		...
		internal static bool HasAllQueryParams(this FluentRestDetail call, string[] names) {
		...
		internal static bool HasAnyQueryParam(this FluentRestDetail call, string[] names) {
		...
		internal static bool HasQueryParams(this FluentRestDetail call, object values) {
		...
		/// null value means just check for existence by name
		/// </summary>
		internal static bool HasHeader(this FluentRestDetail call, string name, object value = null) {
			return (value == null) ?
		...
		/// null value means just check for existence by name
		/// </summary>
		internal static bool HasCookie(this FluentRestDetail call, string name, object value = null) {
			return (value == null) ?
