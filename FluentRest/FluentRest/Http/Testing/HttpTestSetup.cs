...
namespace FluentRest.Http.Testing
{
	...
	public abstract class HttpTestSetup
	{
		...
		protected HttpTestSetup(TestFluentRestHttpSettings settings) {
			Settings = settings;
		}

		/// <summary>
		/// The FluentRestHttpSettings used in fake calls.
		/// </summary>
		public TestFluentRestHttpSettings Settings { get; }
